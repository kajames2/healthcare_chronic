...
display_cols = [
    'Cash', 'Shocks', 'ShockProb', 'AtMaxShocks', 'DieFrac', 'NextFitness',
    'InsurancePaid', 'BuyIns', 'Enjoyment', 'TotalJoy', 'JoySpending',
    'FitnessSpending', 'InsuranceSpending', 'NextCash'
]
...
def get_file_means(dir_name, filebase, condition_on_alive):
    ...
    df.loc[df['Dies'] > 0, 'DieFrac'] = df['Dies'] / (1 - df['AtMaxShocks'] +
                                                      df['Dies'])
    return df
