#ifndef _HEALTHCARE_MODULATOR_FITNESS_COSINE_H_
#define _HEALTHCARE_MODULATOR_FITNESS_COSINE_H_
...
class FitnessCosine : public Modulator {
 public:
  ...
  float GetModulation(int shocks, int fitness) const override {
    ...
    return max_modulation_ * std::sqrt(std::cos(pi/(2 * max_fitness_)*fitness));;
  }
...
#endif  // _HEALTHCARE_MODULATOR_FITNESS_COSINE_H_
