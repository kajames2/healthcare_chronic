...
JoyFunc::JoyFunc(const std::string& func_str,
    ...
    : max_age_(max_age),
      ...
      joy_consts_(joy_consts) {
  expression_str_ = func_str;
  exprtk::symbol_table<double> symbol_table;
  for (const auto& [key, value] : joy_consts_) {
...
double JoyFunc::operator()(unsigned int age, unsigned int shocks,
